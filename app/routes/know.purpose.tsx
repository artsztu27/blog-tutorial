    ...
    <>
      ...
      <div className="container-article">
        <div className="article-page">
          <h1 className="text-h"> 協會起源 </h1>
          <div className="dropdown">
            <button className="button-drop"> About Us</button>
          </div>
          <h4 className="text-sub"> A subtitle of the article page </h4>
          <img
            className="image-img1"
            alt="協會起源"
            src="/assets/photos/Photo_09.jpeg"
          ></img>
          <p className="text-p">
          ...
          <div className="clearfix">
            <img
              ...
              alt="協會起源"
              src="/assets/photos/Photo_08.jpeg"
            ></img>
            <p className="text-p2">
